...
+(CCScene *) scene
{
	...
	KSingLayer *layer = [KSingLayer node];
...
-(void) sing
{
    ...
    if (sae != nil) {
        [sae preloadBackgroundMusic:@"k_sing_new.mp3"];
    }
    
    [sae playBackgroundMusic:@"k_sing_new.mp3" loop:NO];
    train = [CCSprite spriteWithFile:@"k_sing_train_1.png"];
    CCParallaxNode *voidNode = [CCParallaxNode node];
    [voidNode addChild:train z:2 parallaxRatio:ccp(2.0, 0.0)
        positionOffset: ccp(1400,170)];
    
    CCLayer *gameLayer = [CCLayer node];
    [gameLayer addChild:voidNode z:2];
    id delay = [CCDelayTime actionWithDuration:2];
    id go = [CCMoveBy actionWithDuration:19 position:ccp(-1808, 0)];
    ...
    CCSprite *a = [CCSprite spriteWithFile:@"k_sing0.png"];
    a.position = ccp(600, 240);
    [self addChild:a z:3];
    
    id delay1 = [CCDelayTime actionWithDuration:13];
    ...
    id repeat1 = [CCRepeat actionWithAction:action1 times:2];
    id term1 = [CCDelayTime actionWithDuration:15];
    ...
    id delay1_1 = [CCDelayTime actionWithDuration:44];
    ...
    id repeat1_1 = [CCRepeat actionWithAction:action1_1 times:2];
    id term1_1 = [CCDelayTime actionWithDuration:15];
    ...
    CCSprite *b = [CCSprite spriteWithFile:@"k_sing1.png"];
    b.position = ccp(600, 240);
    [self addChild:b z:3];
    
    id delay2 = [CCDelayTime actionWithDuration:17];
    ...
    id repeat2 = [CCRepeat actionWithAction:action2 times:2];
    id term2 = [CCDelayTime actionWithDuration:11];
    ...
    id delay2_1 = [CCDelayTime actionWithDuration:48];
    ...
    id repeat2_1 = [CCRepeat actionWithAction:action2_1 times:2];
    id term2_1 = [CCDelayTime actionWithDuration:11];
    ...
    CCSprite *c = [CCSprite spriteWithFile:@"k_sing2.png"];
    c.position = ccp(600, 240);
    [self addChild:c z:3];
    
    id delay3 = [CCDelayTime actionWithDuration:21];
    ...
    id repeat3 = [CCRepeat actionWithAction:action3 times:2];
    id term3 = [CCDelayTime actionWithDuration:7];
    ...
    id delay3_1 = [CCDelayTime actionWithDuration:52];
    ...
    id repeat3_1 = [CCRepeat actionWithAction:action3_1 times:2];
    id term3_1 = [CCDelayTime actionWithDuration:7];
    ...
    CCSprite *d = [CCSprite spriteWithFile:@"k_sing3.png"];
    d.position = ccp(600, 240);
    [self addChild:d z:3];
    
    id delay4 = [CCDelayTime actionWithDuration:25];
    ...
    id repeat4 = [CCRepeat actionWithAction:action4 times:2];
    id term4 = [CCDelayTime actionWithDuration:3];
    id remove4 = [CCPlace actionWithPosition:ccp(600,240)];
    id total4 = [CCSequence actions:delay4, place4, repeat4,term4, remove4, nil];
    
    [d runAction:total4];
    
    id delay4_1 = [CCDelayTime actionWithDuration:56];
    ...
    id repeat4_1 = [CCRepeat actionWithAction:action4_1 times:2];
    id term4_1 = [CCDelayTime actionWithDuration:3];
    ...
    id delay5 = [CCDelayTime actionWithDuration:64];
    id place5 = [CCPlace actionWithPosition:ccp(160,240)];
    id total5 = [CCSequence actions:delay5, place5, nil];
    [rMenu runAction:total5];
